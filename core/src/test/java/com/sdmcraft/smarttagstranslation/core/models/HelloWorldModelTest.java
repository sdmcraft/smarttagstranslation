 ...
 */
package com.sdmcraft.smarttagstranslation.core.models;

import com.day.cq.wcm.api.Page;
import com.sdmcraft.smarttagstranslation.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
                "sling:resourceType", "smarttagstranslation/components/helloworld");
